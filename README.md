...
<p>A continuacion se muestra todos los sprints y backlog que se realizaron durante este proyecto, al igual que sus respectivas correcciones que se hizieron a lo largo de este periodo, sin embargo lo que diferenciara este docuemnto es que en la parte del final se hizo unas modificaciones a el ultimo sprint y backlog que se realizo, esto se realizo con el trabajo y el analices por parte de 3 estudiantes, para una mejor comprension se decidio dejar los anteriores trabajos que ayudar a ver todo el proceso que conlleva realizar un sprint y backlog segun la metodologia de SCRUM, ademas de mencionar que los profesionaless se dieron la tarea de organizar una reunion para ver que modificaciones se podrian realizar en los trabajos y asi crear un proyecto mas desarrollado y bien estructurado, que abarque aspectos importantes para la implementacion y finalizacion de los proyectos, para complemnetar el trabajo se decidio tambien integrar una bitacora con estas modificaciones y los roles que tuvieron cada participante, dichos cambios se veran reflejados en la parte final de este documento .</P>
  <br>
    <br>  
...
![Captura de pantalla (1043)](https://github.com/user-attachments/assets/56935c57-4e4d-402f-8434-e327ebe7ea7b)

![Captura de pantalla (1044)](https://github.com/user-attachments/assets/b506f45c-bec5-481c-ad2f-e507baa3ee8f)
